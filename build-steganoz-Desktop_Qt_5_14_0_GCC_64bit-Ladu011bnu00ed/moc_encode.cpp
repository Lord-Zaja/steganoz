...
QT_MOC_LITERAL(3, 13, 10), // "slotencode"
QT_MOC_LITERAL(4, 24, 10) // "editchange"

    },
    "Encode\0open\0\0slotencode\0editchange"
};
...
void Encode::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Encode *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->open(); break;
        case 1: _t->slotencode(); break;
        case 2: _t->editchange(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
QT_INIT_METAOBJECT const QMetaObject Encode::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_Encode.data,
    qt_meta_data_Encode,
    qt_static_metacall,
    nullptr,
    nullptr
